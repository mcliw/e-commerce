      ...
      <footer className="flex flex-col justify-between">
        <div className='flex flex-row mt-5'>
          ...
          <div className='flex basis-1/5 mr-16 flex-col'>
            ...
            <div className='flex '>
              <img src="../../icon/facebook.svg" alt="Logo" className="header-logo mr-2" />
              <img src="../../icon/youtube.svg" alt="Logo" className="header-logo mr-2" />
              <img src="../../icon/zalo.svg" alt="Logo" className="header-logo mr-2" />
            </div>
